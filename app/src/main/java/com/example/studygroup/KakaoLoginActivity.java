                    ...
                    UserApiClient.getInstance().me(new Function2<User, Throwable, Unit>() {
                        ...
                        public Unit invoke(User user, Throwable throwable) {
                            ...
                            if (user != null) {
                                ...
                                Toast.makeText(KakaoLoginActivity.this, "사용자 정보 요청 실패 : ", Toast.LENGTH_SHORT).show();
                            }
    ...
    public void clickLogout (View view){
        ...
        UserApiClient.getInstance().logout(new Function1<Throwable, Unit>() {
            ...
            public Unit invoke(Throwable throwable) {
                if (throwable != null)
                    Toast.makeText(KakaoLoginActivity.this, "로그아웃 실패", Toast.LENGTH_SHORT).show();
                else {
                    Toast.makeText(KakaoLoginActivity.this, "로그아웃", Toast.LENGTH_SHORT).show();
                }
                return null;
            }
        });
